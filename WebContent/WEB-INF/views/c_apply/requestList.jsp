...
<ul class="tab-default column3 mt30" data-tab="">
	...
	<li class="active"><a href="#none" onclick="location.href='getRequestList.do'">요청 목록</a></li>
	<li	              ><a href="#none" onclick="location.href='requestLike.do'">관심 인재</a></li>
</ul>
					...
					<c:forEach items="${requestList }" var="request" varStatus="vs">
						<tr>
							...
							<td>
								...
								<c:otherwise>
									<button type="button" class="" style="border: 1px solid" onclick="cancelAction(${request.seq})">요청취소</button>
