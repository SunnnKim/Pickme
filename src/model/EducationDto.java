...
public class EducationDto {
	...
	public EducationDto(int rsmseq, String school, String major, String study, String startdate, String enddate,
			String ing) {
		super();
		this.rsmseq = rsmseq;
		this.school = school;
	...
	public String toString() {
		return "EducationDto [rsmseq=" + rsmseq + ", school=" + school + ", major=" + major + ", study=" + study
