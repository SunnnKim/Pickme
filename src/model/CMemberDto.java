...
public class CMemberDto {
	...
	public CMemberDto(int cMemberSeq, String email, String pwd, String president, String c_name, String tel,
	...
	public CMemberDto(int paySeq, int buyer_id, String service_name, String payDate, int totalPay, int refund,
