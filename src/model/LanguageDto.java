...
public class LanguageDto {
	...
	public LanguageDto(int rsmseq, String lang, String level, String test, String score, String date) {
		super();
		this.rsmseq = rsmseq;
		this.lang = lang;
		this.level = level;
	...
	public String toString() {
		return "LanguageDto [rsmseq=" + rsmseq + ", lang=" + lang + ", level=" + level + ", test=" + test + ", score="
				+ score + ", date=" + date + "]";
	}
